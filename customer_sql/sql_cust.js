...
const accountScript = require('./sql_accounts');
const addressScript = require('./sql_address');
const packageScript = require('./sql_package');
const afterShipScript = require('./sql_after_ship');
const afterCancelScript = require('./sql_after_cancel');

// SCRIPT DETAILS TO SHOW IN RTI CONNECTOR
// Customer Name
exports.customer = 'SQL Company';
...
exports.config = {
  server: 'JOSH-DESKTOP', // SQL Server Name
  authentication: {
    type: 'default',
    options: {
      // Used for SQL Authentication
      userName: 'sa', // SQL Username
      password: 'MOSMcmG2', // SQL Password
    },
  },
  options: {
    // If you are on Microsoft Azure, you need encryption:
    // encrypt: true,
    instanceName: 'SQL2019', // SQL Instance
    database: 'SMART_RTI', // SQL Database name
